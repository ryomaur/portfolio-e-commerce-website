...
const Navbar = () => {
  return (
    <>
      <nav className="w-full font-sans bg-bgtransparent backdrop-blur-[32px] fixed top-0 bg-background">
        <div className="max-w-[1440px] mx-auto h-14 flex items-center justify-between text-foreground">
          ...
          <div className="flex gap-10">
            ...
            >
              <FiChevronRight
                size={16}
                className="absolute left-0 top-0 h-full group-hover:block text-red"
                fontWeight={500}
              />
            ...
            >
              <FiChevronRight
                size={16}
                className="absolute left-0 top-0 h-full hidden group-hover:block text-foreground"
                fontWeight={500}
              />
          ...
          <div className="w-[132px] mr-8 flex items-center gap-7">
            <LuShoppingBag
              size={24}
